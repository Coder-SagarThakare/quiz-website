...
function TeacherProfile() {
  ...
  return (
    <div className="p-3  ">
      {/* profile data card */}
      <div className="glass-effect row align-items-center p-3 gx-0">
        {/* profile photo div */}
        <div className=" p-1  col-2  overflow-hidden">
          <img
            src={user.picture}
            alt={user.picture}
            className="w-100 h-100 rounded-pill profile-img  m-1 float-center "
          />
        </div>

        {/* profile info */}
        <div className=" p-0 col-md-10 row border">
          <div className="row col-12">
            ...
            <div className="d-flex gap-2 col-6 gx-0">
              <div>
